...
const EditProductAdmin = ({close ,data : propsData,fetchProductData}) => {
  ...
  return (
   <section className='fixed top-0 bottom-0 right-0 left-0 bg-black/70 z-50 p-4 '>
    <div className='bg-white w-full max-w-2xl mx-auto rounded overflow-y-auto h-full min-h-[95vh]'>

    <section>
        <div className='p-2 shadow-md bg-white flex items-center justify-between'>
            <h2 className='font-semibold'>Upload Product</h2>
            <button onClick={close} className=' text-black cursor-pointer hover:text-red-600'>
                <IoClose size={20} />
            </button>
        </div>
