  ...
  <section className='w-full container mx-auto px-2'>
    ...
    <p className='font-semibold text-lg'>Enter OTP</p>
        <form className='grid gap-2 py-2'onSubmit={handleSubmit}>
                        ...
                        data.map((element,index)=>{
                            return(
                               ...
                               key={"otp"+index} 
                                ...
                                maxLength={1}
                                type="text" 
                                className='bg-blue-50 w-full max-w-16 text-center font-semibold p-2 border rounded outline-none focus:border-[var(--color-primary-200)]'
                                /> 
                            )
                        })
                    }
            ...
            <button className={` ${valideValue ? "bg-green-800 hover:bg-green-700" : "bg-gray-500"}   text-white py-2 rounded font-semibold my-2 tracking-wide `}>Verify OTP</button>
        </form>
        <p>
